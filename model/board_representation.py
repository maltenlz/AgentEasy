...
class ColorPlusTileEncoder(SimpleOneHotEncoder):
    ...
    Also encodes the color of the tiles placed, as well additional information about the tiles left.
    '''
    ...
    def _one_hot_encode_color(self, board_state):
        '''
        for each board position creates array of length 9 with 1 at the positions of the numbers.
